    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16 lg:py-20">
        <div className="flex flex-col lg:flex-row justify-between items-center lg:items-start gap-8 lg:gap-12">
          ...
          <div className="lg:ml-auto w-40 sm:w-48 lg:w-52 2xl:w-auto">
            <Image
              src="/logo.png"
              alt="Shaurya Logo"
              width={200}
      ...
      <div className="container mx-auto px-4 sm:px-6 pt-8 lg:pt-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12 text-black/80">
          ...
          {/* Phone numbers */}
          <div className="lg:col-span-2 md:col-span-1 flex flex-col gap-3">
            <h3 className="font-semibold mb-3 text-sm text-black">
              Reach out to Us
            </h3>
            <div className="flex lg:flex-col sm:flex-row sm:items-center sm:gap-6">
              <Link href="tel:01140518320" className="text-sm hover:text-black">
          ...
          {/* Footer Links - Pushed to the bottom on mobile */}
          <div className="lg:col-span-2 md:col-span-2 order-last md:order-none">
            <h3 className="font-semibold mb-3 text-sm text-black">
              Quick Links
            </h3>
